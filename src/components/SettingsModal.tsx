...
import { X, Volume2, VolumeX, Moon, Sun, ShieldCheck, Settings, Sparkles } from 'lucide-react';
        ...
        <div className="w-full mb-4">
          ...
          {onReplayIntro && (
            <button
              ...
              className="w-full py-2.5 px-4 rounded-2xl font-bold text-xs sm:text-sm bg-slate-100 hover:bg-slate-200 dark:bg-slate-800 dark:hover:bg-slate-700 text-slate-800 dark:text-slate-200 border border-slate-300 dark:border-slate-700 transition-all flex items-center justify-center gap-2 cursor-pointer"
            >
              <Sparkles className="w-4 h-4 text-amber-500" />
              <span>Watch S.L.Dev Studio Intro</span>
            </button>
          )}
        </div>
